...
Route::prefix('/poliklinik')->group(function () {
    ...
    Route::get('/operasi', [App\Http\Controllers\OperasiController::class, 'index']);
    Route::post('/operasi', [App\Http\Controllers\OperasiController::class, 'store']);
    Route::get('/operasi/{id_operasi}', [App\Http\Controllers\OperasiController::class, 'show']);
    Route::put('/operasi/{id_operasi}', [App\Http\Controllers\OperasiController::class, 'update']);
    Route::delete('/operasi/{id_operasi}', [App\Http\Controllers\OperasiController::class, 'delete']);
});